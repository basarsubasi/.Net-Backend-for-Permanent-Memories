...
namespace WebApplication1.Migrations.AppDb
{
    ...
    [Migration("20240104114510_AppDbMigration2")]
    partial class AppDbMigration2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebApplication1.Models.ItemRelatedModels.Camera", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GUID = new Guid("76ed51af-8386-46f4-a1bf-cd3e185bffda"),
            ...
            modelBuilder.Entity("WebApplication1.Models.ItemRelatedModels.Film", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GUID = new Guid("6ca841ae-612c-4b4b-8ced-09839f84d2b0"),
